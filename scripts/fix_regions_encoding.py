"""
Script para corregir encoding UTF-8 de regiones
"""
import os
import django
...
# Eliminar todas las regiones con encoding incorrecto
Region.objects.all().delete()

# Datos corregidos con encoding UTF-8
regiones_data = [
    {
        "name": "Zibatá",
        "slug": "zibata",
...
for data in regiones_data:
    ...
    print(f"OK Creada: {region.name}")

print("-" * 50)
print(f"Total: {Region.objects.count()} regiones corregidas")
